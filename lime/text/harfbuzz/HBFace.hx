...
abstract HBFace(CFFIPointer) from CFFIPointer to CFFIPointer {
	...
	private static inline var get_empty ():HBFace {
	...
	private inline var get_glyphCount ():Int {
	...
	private inline var set_glyphCount (value:Int):Int {
	...
	private inline var get_immutable ():Bool {
	...
	private inline var get_index ():Int {
	...
	private inline var set_index (value:Int):Int {
	...
	private inline var get_upem ():Int {
	...
	private inline var set_upem (value:Int):Int {
